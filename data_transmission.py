...
class CellService:
    ...
    def send_data(self, data, navsat_data, num_transmissions=1, max_retries=3, base_retry_delay=5, backoff_multiplier=2, max_backoff_delay=30, timeout=30):
            ...
            while not transmission_status:
                ...
                if transmission_status:
                    ...
                    if attempts <= max_retries:
                        retry_delay = self.calculate_retry_delay(base_retry_delay, backoff_multiplier, attempts, max_backoff_delay)
...
def main():
    """Prints the top satellite downlink and performs data transmission."""
    ...
    cell_service.send_data(data, navsat_data, num_transmissions=5, max_retries=3, base_retry_delay=5, backoff_multiplier=2, max_backoff_delay=30, timeout=30)
